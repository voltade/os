drop function if exists stock.update_inventory_on_line_status_change () cascade;

create or replace function stock.update_inventory_on_line_status_change () returns trigger as $plv8$
...
// schemas/stock/functions/update_inventory_on_line_completion.plv8.ts
