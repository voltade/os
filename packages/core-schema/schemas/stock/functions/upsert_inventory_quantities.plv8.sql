drop function if exists internal.upsert_inventory_quantities (
...
create or replace function internal.upsert_inventory_quantities (
  p_product_id integer,
  p_stock_unit_id integer,
  p_warehouse_id integer,
  p_warehouse_location_id integer,
...
// src/schemas/stock/tables/inventory.ts
var inventoryTable = internalSchema.table("stock_inventory", {
  ...DEFAULT_COLUMNS,
  product_id: integer().notNull(),
...
// src/schemas/stock/functions/upsert_inventory_quantities.plv8.ts
